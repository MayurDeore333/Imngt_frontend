...
//   const addSales = async(product,totalQuantitySold,totalProfit) =>{


//   const formData = new FormData();

//   formData.append("totalSales", totalQuantitySold);
//   formData.append("profit", totalProfit);
            ...
            <>
              {filteredSales?.length > 0 ? (
                <div>
                  ...
                  {/* <button className='btn btn-primary' onClick={() => addSales(product,totalQuantitySold,totalProfit)}>
                   Print
                  </button> */}
